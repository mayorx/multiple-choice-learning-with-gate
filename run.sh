...
CUDA_VISIBLE_DEVICES=1 python main.py --epoch 200 --batch-size 64 --lr 0.03 --momentum 0.9 --wd 5e-4 -ct 10 --model-num 5 --gate-type 3 --name mcl-gateonly-feature-as-input --resume result/dcl-cifar-10-mcl-for-cmcl/checkpoint.pth
