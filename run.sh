...
CUDA_VISIBLE_DEVICES=2 python main.py --epoch 200 --batch-size 64 --lr 0.01 --momentum 0.9 --wd 5e-4 -ct 100 --model-num 5 --gate-type 3 --name train-union-together --resume result/dcl-cifar-100-mn-5-gt-3-train-union-together/checkpoint-epoch-59-Gate.pth