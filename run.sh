...
CUDA_VISIBLE_DEVICES=1 python main.py --epoch 200 --batch-size 64 --lr 0.1 --momentum 0.9 --wd 5e-4 -ct 100 --model-num 5 --gate-type 3 --name mcl-twostep-manually --resume result/dcl-cifar-100-mn-5-gt-3-mcl-twostep-manually/checkpoint.pth --evaluate