...
CUDA_VISIBLE_DEVICES=0 python main.py --epoch 200 --batch-size 64 --lr 0.1 --momentum 0.9 --wd 5e-4 -ct 100 --model-num 2 --gate-type 3 --name unknown --evaluate --resume result/dcl-cifar-100-mcl-twostep-2/checkpoint.pth