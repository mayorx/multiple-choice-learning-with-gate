...
CUDA_VISIBLE_DEVICES=0 python main.py --epoch 200 --batch-size 64 --lr 0.005 --momentum 0.9 --wd 5e-4 -ct 100 --model-num 5 --gate-type 3 --name mcl-twosetp-batch-acc-pretrain-1 --resume result/dcl-cifar-100-mn-5-gt-3-ie1/checkpoint.pth